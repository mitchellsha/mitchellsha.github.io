...
var projects = [{title:'Logo IDE',
				...
				{title:'Q-Learning Obstacle Avoider',
				 ...
				 image:'qlearner.png',
				 link:'https://github.com/mitchellsha/AI-Projects/tree/master/src/robosim',
				...
				{title:'Character Classifier',
				 ...
				 link:'https://github.com/mitchellsha/AI-Projects/tree/master/src/handwriting',
				 assignment:'http://ozark.hendrix.edu/~ferrer/courses/335/f15/projects/project6/'},
				{title:'Maze Solver',
				 subtitle:'',
				 description:'Simulates an "explorer" navigating a randomly generated maze. Features a list of selectable distance metrics to utilize in navigation.',
				 image:'maze.png',
				 link:'https://github.com/mitchellsha/AI-Projects/tree/master/src/maze',
